document.getElementById("btnCerca").addEventListener("click", () => {
...
document.getElementById("btnNuovoCliente").addEventListener("click", () => {
  document.getElementById("modal-nuovo-cliente").classList.remove("hidden");
});

document.getElementById("annullaCliente").addEventListener("click", () => {
  document.getElementById("modal-nuovo-cliente").classList.add("hidden");
});

document.getElementById("salvaCliente").addEventListener("click", async () => {
